      ...
      >
        <div className={`${isOpen ? 'block' : 'hidden'} w-full  mt-4`}>
          <ul className="flex flex-col">
            ...
            <li className="text-white">
              <Link to="/external/facultyincarge" className="block px-2 py-2 hover:bg-[#6a2121] hover:text-white hover:rounded-lg" >
                Faculty Incharge
              </Link>
            </li>
            <li className="text-white">
              <Link to="/external/studentcommitte" className="block px-2 py-2 hover:bg-[#6a2121] hover:text-white hover:rounded-lg">
