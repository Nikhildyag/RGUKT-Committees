...
const cardData={name:'Hostel Committee',complaintForm:'/academiccommittefeedbackform',purPose:'The Hostel Committee is dedicated to ensuring a comfortable and supportive living environment for resident students in campus hostels. By overseeing accommodation and facilities, addressing concerns related to maintenance, hygiene, and security, the committee strives to enhance the overall hostel experience. Organizing recreational activities and cultural events for residents fosters a sense of community and belonging. The committee also ensures adherence to hostel rules and regulations, promoting a safe and conducive environment for all residents.',  rolesAndResponsibilities:[' Oversee hostel accommodation and facilities for resident students.','Address concerns related to hostel maintenance, hygiene, and security.','Organize recreational activities and cultural events for hostel residents.','Ensure adherence to hostel rules and regulations.']      
}
const Hostel = () => {
  return (
