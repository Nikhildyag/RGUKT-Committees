                ...
                <div className="w-full md:w-[800px] flex flex-row bg-white shadow-2xl border-2 border-black-400 p-6 rounded-lg">
                    ...
                    <div className="my-5 ml-3">
                        ...
                        <p className="text-left">
                            are you
                        <Link to="/centralauthorityloginForm" className="text-teal-500 hover:underline">
                            CentralAuthority 
                        </Link>
                        </p>
                        <p className="text-left">
                        Are you ?
                        <Link to="/facultyinchargeloginForm" className="text-teal-500 hover:underline">
                            facultyincarge
                        </Link>
                                </p>
                                <p className="text-left">
                        Are you ?
                        <Link to="/departmentloginform" className="text-teal-500 hover:underline">
                            Departmentmember
                        </Link>
                        </p>
                    </div>
