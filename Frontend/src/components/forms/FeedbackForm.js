  ...
  return (
    <div className="flex flex-col h-screen overflow-x-hidden">
      ...
      <div className="flex flex-1 overflow-auto sm:max-w-full md:max-w-3/4 overflow-x-hidden">
        ...
        <div className=" h-fit lg:fixed py-[4%] lg:mt-[0.1em] sm:w-[90%] sm:ml-[5%]  sm:mt-12 sm:px-4 lg:w-[70%] rounded-lg lg:ml-[23%]  md:w-[70%] md:ml-[14rem] md:mt-[2rem]  flex items-center justify-center  bg-white">
